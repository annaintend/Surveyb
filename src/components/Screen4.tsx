...
export function Screen4({ onNext }: Screen4Props) {
  ...
  const options = [
    { id: 'stable', label: 'Stable and clear' },
    { id: 'heavy', label: 'Heavy or sleepy' },
    { id: 'foggy', label: 'Foggy' },
    { id: 'depends', label: 'It depends on the meal' }
  ];
        ...
        >
          ...
          <div className="mb-6 flex-shrink-0">
            <h1 className="font-['Inter:Semi_Bold',sans-serif] font-semibold text-[28px] leading-[28.8px] tracking-[0.4px] text-black">
              How does your energy usually feel after meals?
            </h1>
          </div>
