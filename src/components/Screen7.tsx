...
export function Screen7({ onNext }: Screen7Props) {
  ...
  const options = [
    { id: 'mostly-stable', label: 'Mostly stable' },
    { id: 'good-morning', label: 'Good in the morning, low later' },
    { id: 'comes-in-waves', label: 'Comes in waves' },
    { id: 'hard-to-predict', label: 'Hard to predict' }
  ];
        ...
        >
          ...
          <div className="mb-6 flex-shrink-0">
            <h1 className="font-['Inter:Semi_Bold',sans-serif] font-semibold text-[28px] leading-[28.8px] tracking-[0.4px] text-black">
              Does your energy feel predictable during the day?
            </h1>
          </div>
